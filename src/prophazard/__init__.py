...
def prophazard_webserver(
    ...
    webserver_config.ca_certs = ca_cert_file if isinstance(ca_cert_file, str) else None
    ...
    redirects = get_config("WEBSERVER", "FORCE_REDIRECTS")
    if redirects:
